							...
							<tr>
                                <td class="w-32">
                                    <?php if(is_array($data->img)): ?>
                                        <?php $__currentLoopData = $data->img; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <img src="<?php echo e(asset($image)); ?>" alt="<?php echo e($data->name); ?>" class="!w-full !h-auto !rounded-none mb-2">
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    <?php else: ?>
                                        <img src="<?php echo e(asset($data->img)); ?>" alt="<?php echo e($data->name); ?>" class="!w-full !h-auto !rounded-none">
                                    <?php endif; ?>
                                </td>
...
<?php endif; ?>
<?php /**PATH /home/rishi/Desktop/restaurant-site-laravel/resources/views/admin/pages/foodmenu/foodmenu.blade.php ENDPATH**/ ?>