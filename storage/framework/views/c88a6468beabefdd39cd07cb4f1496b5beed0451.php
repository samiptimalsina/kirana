    ...
    <div class="flex flex-wrap justify-center mt-5 team-slider">
        ...
        <div class="owl-item bg-white flex flex-wrap flex-col items-start md:flex-row m-5 max-w-[530px] px-6 py-5 rounded h-auto shadow-lg">
            ...
            <div class="flex-grow">
                ...
                <span class="pt-2 text-sm text-gray-700 font-sans-lato italic leading-relaxed"><?php echo e($data['role']); ?></span>
                <p class="pt-3 text-sm text-gray-700 font-sans-lato leading-relaxed"><?php echo e($data['email']); ?></p>
                <span class="pt-2 text-sm text-gray-700 font-sans-lato italic leading-relaxed"><?php echo e($data['description']); ?></span>
            </div>
        </div>
