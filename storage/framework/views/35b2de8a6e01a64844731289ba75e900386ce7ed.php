    ...
    <div class="container mx-auto p-4">
        ...
        <form action="<?php echo e(isset($dealer) ? route('dealers.update', $dealer->id) : route('dealers.store')); ?>" method="POST">
            ...
            <div class="flex items-center justify-between">
                ...
                <a href="<?php echo e(route('dealers.index')); ?>" class="inline-block align-baseline font-bold text-sm text-blue-500 hover:text-blue-800">
                    Cancel
                </a>
            </div>
        </form>
...
<?php endif; ?>
<?php /**PATH /home/samiptimalsina/betal.techzillasoft.com/resources/views/admin/dealers/create.blade.php ENDPATH**/ ?>