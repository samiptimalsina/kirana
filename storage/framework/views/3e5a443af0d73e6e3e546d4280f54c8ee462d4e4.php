    ...
    <section id="about"
        ...
        <div class="basis-[400px] grow max-w-[650px] p-5">
            ...
            <a href="#"
                class="inline-block rounded-sm shadow-md mt-7 px-5 py-3 bg-lime-400 uppercase font-sans-monts text-xs font-bold text-slate-900 border border-transparent transition ease-in-out duration-300 hover:-translate-y-1 hover:scale-110 hover:bg-transparent hover:border-lime-400">book
                a Product</a>
        </div>
    </section>
    <!-- Welcome Area End -->
<?php /**PATH /home/samiptimalsina/betal.techzillasoft.com/resources/views/home/partials/welcome.blade.php ENDPATH**/ ?>