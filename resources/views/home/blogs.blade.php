    ...
    <main class="container mx-auto py-6">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div class="bg-white shadow-md rounded-lg p-4">
                <div class="mb-4">
                <img src="{{ asset('assets/images/blog/' . $blog->image) }}" alt="{{ $blog->title ?? '' }}" class="w-full h-48 object-cover rounded-lg">
                </div>
                <h2 class="text-xl font-semibold text-gray-800 mb-2 hidden">{{ $blog->title ?? '' }}</h2>
               <p class="text-gray-600 mb-4">{!! substr($blog->short_desc, 0, 80) !!}</p>
