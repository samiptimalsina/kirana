            ...
            <form action="{{ route('add.new.order', $reservation->id) }}" method="POST"
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="receiver_name"
                        value="{{ old('receiver_name', $reservation->name ?? '') }}" id="receiver_name"
                        class="w-full mt-2 p-2 border border-gray-300 rounded-md @error('receiver_name') border-red-500 @enderror"
                        required>
                    @error('receiver_name')
                        <p class="text-red-500 text-sm mt-2">{{ $message }}</p>
                    @enderror
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="receiver_contact"
                        value="{{ old('receiver_contact', $reservation->phone_number ?? '') }}" id="receiver_contact"
                        class="w-full mt-2 p-2 border border-gray-300 rounded-md @error('receiver_contact') border-red-500 @enderror"
                        required>
                ...
                <div class="mb-4">
                    <label for="receiver_alternate_number" class="block text-sm font-medium text-gray-700">Alternate
                        Contact</label>
                    <input type="text" name="receiver_alternate_number"
                        value="{{ old('receiver_alternate_number') }}" id="receiver_alternate_number"
                        class="w-full mt-2 p-2 border border-gray-300 rounded-md @error('receiver_alternate_number') border-red-500 @enderror">
                ...
                <div class="mb-4">
                    ...
                    <input type="number" step="0.01" name="product_price"
                        ...
                        class="w-full mt-2 p-2 border border-gray-300 rounded-md @error('product_price') border-red-500 @enderror"
                        required>
                    @error('product_price')
                        <p class="text-red-500 text-sm mt-2">{{ $message }}</p>
                    @enderror
                ...
                <div class="mb-4">
                    ...
                    <input type="number" step="0.01" name="cod_amount" value="{{ old('cod_amount') }}"
                        id="cod_amount"
                        class="w-full mt-2 p-2 border border-gray-300 rounded-md @error('cod_amount') border-red-500 @enderror">
                    @error('cod_amount')
                        <p class="text-red-500 text-sm mt-2">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="mb-4">
                    ...
                    <textarea name="product_description" id="product_description"
                        class="w-full mt-2 p-2 border border-gray-300 rounded-md @error('product_description') border-red-500 @enderror"
                        rows="3">{{ old('product_description', $reservation->food?->desc ?? '') }}</textarea>
                ...
                <div class="mb-4">
                    ...
                    <textarea name="receiver_address" id="receiver_address"
                        class="w-full mt-2 p-2 border border-gray-300 rounded-md @error('receiver_address') border-red-500 @enderror"
                        rows="3">{{ old('receiver_address', $reservation->address ?? '') }}</textarea>
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="receiver_landmark" id="receiver_landmark"
                        ...
                        class="w-full mt-2 p-2 border border-gray-300 rounded-md @error('receiver_landmark') border-red-500 @enderror">
                ...
                <div class="mb-4">
                    ...
                    <textarea name="remarks" id="remarks"
                        class="w-full mt-2 p-2 border border-gray-300 rounded-md @error('remarks') border-red-500 @enderror"
                ...
                <div class="mb-4">
                    ...
                    <textarea name="client_note" id="client_note"
                        ...
                        rows="3">{{ old('client_note') }}</textarea>
                    @error('client_note')
                        <p class="text-red-500 text-sm mt-2">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <button type="submit"
                    class="w-full py-2 px-4 bg-amber-500 text-white font-semibold rounded-md hover:bg-amber-700">
                    Submit Order
                </button>
            </form>
        </div>
