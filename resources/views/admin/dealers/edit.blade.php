    ...
    <div class="container mx-auto p-4">
        ...
        <form action="{{ isset($dealer) ? route('dealers.update', $dealer->id) : route('dealers.store') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="google_map" value="{{ old('google_map', $dealer->google_map ?? '') }}" class="border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
            </div>
